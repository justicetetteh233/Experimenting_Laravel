...
<body>
    ...
    <!-- Create Voter Modal -->
    <div class="modal fade" id="createCandidateModal" tabindex="-1" aria-labelledby="createCandidateModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createCandidateModalLabel">Create Voter</h5>
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('candidates.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="user_type" class="col-md-4 col-form-label text-md-end">{{"Position"}}</label>
                            <div class="col-md-6">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <a href="{{ URL::route('candidates.edit', $candidate) }}" class="btn btn-primary btn-sm">Edit</a>
