        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header">
                    ...
                    <img src="{{ asset('storage/' . $candidate->picture_path) }}" class="voter-picture" alt="picture" style="max-width: 150px; max-height: 150px;">

                    <span> Edit <strong>{{$candidate->name}}</strong> </span>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('candidates.update', $candidate) }}"  enctype="multipart/form-data" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="{{$candidate->name}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="{{$candidate->email}}">
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <a href="{{ URL::route('candidates.index', $candidate) }}" class="btn btn-danger btn-sm">Cancel</a>
